...
function Card() {
  return (
    <div>
      <div className="main bg-gray-200 py-1 md:py-8 w-3/4 md:w-2/3 mx-auto my-8 md:my-16 rounded-xl shadow-xl">
        ...
        <div className="items md:flex">
          ...
          <div className="bg-gray-50 md:w-2/3 mx-auto py-6 rounded-lg md:-mr-10 ">
            <div className="content px-2">
              ...
              <p className="text-sm leading-6 pb-6">
                I help businesses and individuals build their online presence
                by creating responsive and scalable websites and web
                applications. I primarily use JavaScript, React, HTML,
                CSS/Tailwind among other technologies to deliver exceptional
                user experience.
              </p>
