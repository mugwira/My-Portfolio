...
function Skills() {
  return (
    <div className="bg-gray-100 h-screen">
      ...
      <div className="container flex gap-4 p-16 ">
        <div className="flex flex-col items-center space-y-2 text-2xl bg-gray-50 rounded-lg shadow-2xl w-1/3 py-1">
          <IoLogoJavascript />
        ...
        <div className="flex flex-col items-center pace-y-2 text-2xl bg-gray-50 rounded-lg shadow-2xl w-1/3 py-1">
          <SiJquery />
